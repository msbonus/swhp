...
from .phy import env as e
from .phy.env import Environment
from .phy.htf import HTF
from .phy.machine import *


def run():
    envr = Environment()
    envr.waterIn = HTF(25 + e.TK0, 20)

    htfin = HTF(70 + e.TK0, 90)
    graph = Digraph()

    hp_1 = HP_Machine(0.495)
    hp_1.dT = 5
    hp_1.waterIn = envr.waterIn
    hp_1.waterOut = envr.waterOut
    hp_1.label = "HP_1"
    hp_1.pwrin_max = ElecPower(6500, "k")
    hp_1.htfout_max = HTF(88 + e.TK0, 165.8)
